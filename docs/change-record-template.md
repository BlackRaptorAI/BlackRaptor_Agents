...
| PR | #___ |
| Spec / plan | {{SPEC_DIR}}/___ / {{PLAN_DIR}}/___ |
| Author | {{YOUR_NAME}} |
| Date | YYYY-MM-DD |
...
| Domain ({{REGULATED_DOMAIN}}) | domain-compliance | Yes / N/A: ___ | | | |
...
- Two-person rule (Tier 3 only): {{SECOND_APPROVER}} approval on PR #___ — <link>
