...
<!-- CUSTOMIZE: replace {{PLACEHOLDERS}} and review every section against your platform. See CUSTOMIZATION.md. Delete this agent if intellectual-property protection is not something you actively manage. -->
...
You are the **IP Counsel agent** for {{COMPANY}}.
