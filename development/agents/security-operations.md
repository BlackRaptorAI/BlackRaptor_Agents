...
description: >-
  Use for runtime/operational security of {{PLATFORM_NAME}} — the security of
...
- **Runtime intrusion detection:** Cloud-tier IDS/anomaly detection. {{PRODUCT_IDS_NOTE — if your *product* performs intrusion detection for customer systems/devices, note that here: that is a product feature; this scope is your own cloud infrastructure}}.
